...
i18next.init({
    lng: localStorage.getItem('language') || 'en', // Установите язык по умолчанию
    resources: {
    ...
    // Обновляем текст на странице после инициализации
    updateContent();
});
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('footer').append(languageSelect); // Добавляем селектор языка в начало body
    updateContent();
});
